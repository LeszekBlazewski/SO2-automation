...
curl --header "Content-Type: application/json" \
    ...
    --show-error \
    --output /dev/null \
    --data '{"description":"Students group which allows access only to user branches", "uuid":"'"${students_group_uuid}"'", "owner_id" : "Administrators"}' \
...
# Clean after performing all operations
rm -rf "$project_location"
