...
sed -i "s/students_group_uuid/${students_group_uuid}/" "$config_files_location/groups"
...
# Insert administrators uuid into group file
sed -i "s/administrators_group_uuid/${administrators_group_uuid}/" "$config_files_location/groups"
